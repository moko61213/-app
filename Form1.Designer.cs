namespace 料理を記録する日記
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            日付の保存ToolStripMenuItem = new ToolStripMenuItem();
            ...
            // 
            ファイルToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { 画像を開くToolStripMenuItem, 保存ToolStripMenuItem, 料理日記の保存ToolStripMenuItem, 日付の保存ToolStripMenuItem, 変更ToolStripMenuItem, 終了ToolStripMenuItem });
            ...
            画像を開くToolStripMenuItem.Size = new Size(180, 22);
            ...
            料理日記の保存ToolStripMenuItem.Size = new Size(180, 22);
            料理日記の保存ToolStripMenuItem.Text = "料理日記の保存";
            // 
            // 日付の保存ToolStripMenuItem
            // 
            日付の保存ToolStripMenuItem.Name = "日付の保存ToolStripMenuItem";
            日付の保存ToolStripMenuItem.Size = new Size(180, 22);
            日付の保存ToolStripMenuItem.Text = "日付の保存";
            // 
            // 変更ToolStripMenuItem
            // 
            変更ToolStripMenuItem.Name = "変更ToolStripMenuItem";
            変更ToolStripMenuItem.Size = new Size(180, 22);
            変更ToolStripMenuItem.Text = "タイトル画面に戻る";
            変更ToolStripMenuItem.Click += 変更ToolStripMenuItem_Click;
            // 
            // 終了ToolStripMenuItem
            // 
            ...
            画像編集ToolStripMenuItem.Size = new Size(67, 20);
        ...
        private ToolStripMenuItem 日付の保存ToolStripMenuItem;
